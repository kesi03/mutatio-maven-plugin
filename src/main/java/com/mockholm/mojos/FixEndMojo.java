...
/**
 * This Mojo is used to end the fix branch.
 * It is typically called at the end of the build process to finalize the fix branch.
 */
@Mojo(name = "fix-end", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class FixEndMojo extends AbstractMojo {
    /**
