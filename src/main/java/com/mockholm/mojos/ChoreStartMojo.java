...
/**
 * This Mojo is used to start the chore branch.
 * It is typically called at the beginning of the build process to initialize the chore branch.
 */
@Mojo(name = "chore-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class ChoreStartMojo extends AbstractMojo {
        /**
        ...
        public void execute() {
               new BranchMojo(new MojoCommons().
                       ...
                       withProject(project).
                       withSettings(settings)).executeStart(BranchType.CHORE);
        }
