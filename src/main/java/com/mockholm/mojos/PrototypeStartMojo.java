...
/**
 * This Mojo is used to start the prototype branch.
 * It is typically called at the beginning of the build process to initialize the prototype branch.

 */
@Mojo(name = "prototype-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class PrototypeStartMojo extends AbstractMojo {
    ...
    public void execute() {
        new BranchMojo(new MojoCommons()
                ...
                .executeStart(BranchType.PROTOTYPE);
    }
}
