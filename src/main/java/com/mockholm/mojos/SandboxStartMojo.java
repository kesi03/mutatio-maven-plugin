...
/**
 * This Mojo is used to start the sandbox branch.
 * It is typically called at the beginning of the build process to initialize the sandbox branch.
 */
@Mojo(name = "sandbox-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class SandboxStartMojo extends AbstractMojo {
    ...
    public void execute() {
        new BranchMojo(new MojoCommons()
                ...
                .executeStart(BranchType.SANDBOX);
    }
}
