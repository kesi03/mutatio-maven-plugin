...
/**
 * This Mojo is used to start an improvement branch.
 * It is typically called at the beginning of the build process to create a new improvement branch.
 */
@Mojo(name = "improvement-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class ImprovementStartMojo extends AbstractMojo {
    ...
    public void execute() {
        new BranchMojo(new MojoCommons()
                ...
                .executeStart(BranchType.IMPROVEMENT);
    }
}
