...
/**
 * This Mojo is used to end the CI branch.
 * It is typically called at the end of the build process to finalize the CI branch.
 */
@Mojo(name = "ci-end", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class CiEndMojo extends AbstractMojo {
