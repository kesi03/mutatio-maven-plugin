...
/**
 * This Mojo is used to end the experiment branch.
 * It is typically called at the end of the build process to finalize the experiment branch.
 */
@Mojo(name = "experiment-end", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class ExperimentEndMojo extends AbstractMojo {
    ...
    public void execute(){
        new BranchMojo(new MojoCommons()
                ...
                .executeEnd(BranchType.EXPERIMENT);
    }
}
