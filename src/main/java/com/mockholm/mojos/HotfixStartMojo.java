...
/**
 * This Mojo is used to start a hotfix branch.
 * It is typically called at the beginning of the build process to create a new hotfix branch.
 */
@Mojo(name = "hotfix-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class HotfixStartMojo extends AbstractMojo {
    /**
    ...
    public void execute() {
        new BranchMojo(new MojoCommons()
                ...
                .executeStart(BranchType.HOTFIX);
    }
}
