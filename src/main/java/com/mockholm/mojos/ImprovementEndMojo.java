...
/**
 * This Mojo is used to end the improvement branch.
 * It is typically called at the end of the build process to finalize the improvement branch.
 */
@Mojo(name = "improvement-end", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class ImprovementEndMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        new BranchMojo(new MojoCommons()
                ...
                .executeEnd(BranchType.IMPROVEMENT);
    }
}
