...
/**
 * This Mojo is used to start the bugfix branch.
 * It is typically called at the beginning of the build process to initialize the bugfix branch.
 */
@Mojo(name = "bugfix-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class BugfixStartMojo extends AbstractMojo {
    ...
    public void execute() {
        new BranchMojo(new MojoCommons()
                ...
                .executeStart(BranchType.BUGFIX);
    }
}
