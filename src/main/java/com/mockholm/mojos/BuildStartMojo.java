...
/**
 * This Mojo is used to start the build branch.
 * It is typically called at the beginning of the build process to initialize the build branch.
 */
@Mojo(name = "build-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class BuildStartMojo extends AbstractMojo {
    /**
