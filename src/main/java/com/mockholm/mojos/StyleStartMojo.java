...
/**
 * This Mojo is used to start the style branch.
 * It is typically called at the beginning of the build process to initialize the style branch.
 */
@Mojo(name = "style-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class StyleStartMojo extends AbstractMojo {
    /**
