...
/**
 * This Mojo is used to end the style branch.
 * It is typically called at the end of the build process to finalize the style branch.
 */
@Mojo(name = "style-end", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class StyleEndMojo extends AbstractMojo {
