...
/**
 * This Mojo is used to start the performance branch.
 * It is typically called at the beginning of the build process to initialize the performance branch.
 */ 
@Mojo(name = "perf-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class PerfStartMojo extends AbstractMojo {
    /**
