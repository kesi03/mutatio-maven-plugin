...
/**
 * This Mojo is used to start the docs branch.
 * It is typically called at the beginning of the build process to initialize the docs branch.
 */
@Mojo(name = "docs-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class DocsStartMojo extends AbstractMojo {
    ...
    private boolean pushChanges;
        ...
        public void execute() {
                new BranchMojo(new MojoCommons().
                        ...
                        withProject(project).
                        withSettings(settings)).executeStart(BranchType.DOCS);
        }
}
