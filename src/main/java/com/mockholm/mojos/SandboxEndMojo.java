...
/**
 * This Mojo is used to end the sandbox branch.
 * It is typically called at the end of the build process to finalize the sandbox branch.
 */
@Mojo(name = "sandbox-end", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class SandboxEndMojo extends AbstractMojo {
