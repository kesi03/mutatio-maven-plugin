...
/**
 * This Mojo is used to start the CI branch.
 * It is typically called at the beginning of the build process to initialize the CI branch.
 */
@Mojo(name = "ci-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class CiStartMojo extends AbstractMojo {
