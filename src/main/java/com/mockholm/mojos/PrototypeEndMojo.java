...
/**
 * This Mojo is used to end the prototype branch.
 * It is typically called at the end of the build process to finalize the prototype branch.
 */
@Mojo(name = "prototype-end", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class PrototypeEndMojo extends AbstractMojo {
    /**
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        new BranchMojo(new MojoCommons()
                ...
                .executeEnd(BranchType.PROTOTYPE);
    }
}
