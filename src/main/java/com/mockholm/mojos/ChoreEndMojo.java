...
/**
 * This Mojo is used to end the chore branch.
 * It is typically called at the end of the build process to finalize the chore branch.
 */
@Mojo(name = "chore-end", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class ChoreEndMojo extends AbstractMojo {
