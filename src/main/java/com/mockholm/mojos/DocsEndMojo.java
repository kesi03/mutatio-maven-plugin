...
/**
 * This Mojo is used to end the documentation branch.
 * It is typically called at the end of the build process to finalize the documentation branch.
 */
@Mojo(name = "docs-end", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class DocsEndMojo extends AbstractMojo {
