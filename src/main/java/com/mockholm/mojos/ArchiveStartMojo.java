...
/**
 * This Mojo is used to start the archive branch.
 * It is typically called at the beginning of the build process to initialize the archive branch.
 */
@Mojo(name = "archive-start", aggregator = true, defaultPhase = LifecyclePhase.NONE)
public class ArchiveStartMojo extends AbstractMojo {
    ...
    public void execute() {
        new BranchMojo(new MojoCommons()
                ...
                .executeStart(BranchType.ARCHIVE);
    }
}
